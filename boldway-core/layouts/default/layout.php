	...
	<div id="warp-inner">
    	...
    	<div id="site-header">
        	<div id="site-header-inner">
            	<?php boldway_get_file('layouts/'.$boldway_file_data['site_layout'].'/_header.php', $boldway_file_data); ?>
            </div>
        </div><!--#site-header-->
        
        <div id="site-subheader">
        	<div id="site-subheader-inner">
            	<?php boldway_get_file('layouts/'.$boldway_file_data['site_layout'].'/_subheader.php', $boldway_file_data); ?>
            </div>
        </div><!--#site-header-->
        
        <div id="site-main">
        	<div id="site-main-inner">
            	<?php boldway_get_file('layouts/'.$boldway_file_data['site_layout'].'/_main.php', $boldway_file_data); ?>
            </div>
        </div><!--#site-header-->
        
        <div id="site-footer">
        	<div id="site-footer-inner">
            	<?php boldway_get_file('layouts/'.$boldway_file_data['site_layout'].'/_footer.php', $boldway_file_data); ?>
            </div>
        </div><!--#site-header-->
